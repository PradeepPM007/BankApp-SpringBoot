...
public class AccountController {
    ...
    public String addAccount(HttpServletRequest request) {
        ...
        account.setApplicationId(request.getParameter("applicationId"));
    ...
    public String update(@PathVariable String applicationId, Model model, HttpServletRequest request) {
    	...
    	if(account == null)return "redirect:/account/search?error=true";
...
//    }
    ...
    public String displaySearch(){
        return "admin/searchAccount";
    }
    @RequestMapping(value = "/searchAccount",method = RequestMethod.POST)
    public String search(HttpServletRequest request) {
        String option = request.getParameter("option");
        if(option.equals("EDIT")) {
            return "redirect:/account/" + request.getParameter("applicationId") + "/editAccount";
        }
