...
public class CustomerController {
    ...
    public String updatePayee( HttpServletRequest request) {
    ...
    public ModelAndView searchPayee(HttpServletRequest request) throws Exception {
    	ModelAndView modelAndView = new ModelAndView("customerOp/showReport");
    	User activeUser = userManager.findByUsername(request.getRemoteUser());
        List<Log> report = logManager.findByUser(activeUser);
...
//        return "redirect:/customerOp/report";
//    }
    
    @RequestMapping(value = "/all-items-from-database",method = RequestMethod.GET)
